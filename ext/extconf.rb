...
def probe
  @probe ||= case RUBY_PLATFORM
             ...
             when /aarch64-linux/
               OpenStruct.new(script: 'linux', platform: 'buster_arm64', ext: 'deb')
             else
...
# Some examples:
# "https://github.com/kumoas/wkhtmltopdf-installer-arm64/releases/download/0.1.1/wkhtmltox-0.1.1.linux_amd64.deb"
# "https://github.com/kumoas/wkhtmltopdf-installer-arm64/releases/download/0.1.1/wkhtmltox-0.1.1.linux_i386.deb"
# "https://github.com/kumoas/wkhtmltopdf-installer-arm64/releases/download/0.1.1/wkhtmltox-0.1.1.macos_cocoa.pkg"
# "https://github.com/kumoas/wkhtmltopdf-installer-arm64/releases/download/0.1.1/wkhtmltox_0.1.1.buster_arm64.deb"

def package_url
  "https://github.com/kumoas/wkhtmltopdf-installer-arm64/releases/download/#{version}/wkhtmltox-#{version}.#{probe.platform}.#{probe.ext}"
end
